...
public class HorrorBooks extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        * */
        ...
        recyclerView.addItemDecoration(new HorrorBooks.GridSpacingItemDecoration(2, dpToPx(10), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());


        try {
            Glide.with(this).load(R.drawable.horror).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        mDatabase=firebaseDatabase.getReference("books").child("Horror");
    ...
    private void setAdapter(final String searchedString) {
        databaseReference.child("books").child("Fiction").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                fullNameList.clear();
                ...
                * */
                ...
                searchAdapter = new SearchAdapter(HorrorBooks.this, fullNameList);
    ...
    private void initCollapsingToolbar() {
        ...
        collapsingToolbar.setTitle("Fiction");
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle(getString(R.string.fiction));
                    isShow = true;
                } else if (isShow) {
                    collapsingToolbar.setTitle("ExtraOrdinary");
                    isShow = false;
                }
            }
        });
