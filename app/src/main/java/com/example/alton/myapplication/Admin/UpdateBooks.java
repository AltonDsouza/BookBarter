...
import com.example.alton.myapplication.EditBooks;
...
public class UpdateBooks extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new UpdateBooks.GridSpacingItemDecoration(2, dpToPx(10), true));
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    String s5 = ds.getValue(BookOwn.class).getUid();

                    if (s5.contentEquals("john@gmail.com")) {
