...
/**
 * Created by alton on 2/10/2018.
 */

public class EducationBooks extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new EducationBooks.GridSpacingItemDecoration(2, dpToPx(10), true));
        ...
        * */
        ...
        progressDialog.show();
        mDatabase=firebaseDatabase.getReference("books").child("Educational");
    ...
    private void setAdapter(final String searchedString) {
        databaseReference.child("books").child("Educational").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                fullNameList.clear();
                ...
                * */
                ...
                searchAdapter = new SearchAdapter(EducationBooks.this, fullNameList);
    ...
    private void initCollapsingToolbar() {
        ...
        collapsingToolbar.setTitle("Educational");
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle(getString(R.string.education));
                    isShow = true;
                } else if (isShow) {
                    collapsingToolbar.setTitle("Knowledge");
                    isShow = false;
                }
            }
        });
